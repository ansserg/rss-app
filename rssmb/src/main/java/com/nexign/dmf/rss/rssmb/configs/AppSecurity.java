package com.nexign.dmf.rss.rssmb.configs;


import com.nexign.dmf.rss.rssmb.utils.KeycloakJwtRolesConverter;
...
//                        .requestMatchers("/rssmb/operator/*").hasRole("user")
                        .requestMatchers("/rssmb/**").hasRole("user"))
